	...
	:Base(eType_UI)
{
	...
	m_img[1] = COPY_RESOURCE("S_block", CImage);
	m_img[2] = COPY_RESOURCE("Z_block", CImage);
	m_img[3] = COPY_RESOURCE("J_block", CImage);
	m_img[4] = COPY_RESOURCE("L_block", CImage);
	m_img[5] = COPY_RESOURCE("T_block", CImage);
	m_img[6] = COPY_RESOURCE("I_block", CImage);
